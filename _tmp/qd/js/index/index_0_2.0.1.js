 ...
 * Created: 15-11-14
 */
LBF.define('site.index.index_0_2', function (require, exports, module) {
    ...
    exports = module.exports = Node.inherit({
        ...
        init: function () {
             ...
             */
            require.async('../component/jquery.lazyload.0.1', function () {
                $("img.lazy").lazyload({threshold: 100});
            });
            ...
            //编辑推荐5张轮播
            require.async('../component/carousel.0.1', function () {
        ...
        init3dSlide: function () {
             ...
             */
            require.async('../component/roundabout.0.1', function (id) {
                $('.roundabout').fadeIn();
        ...
        btnFilterSearch: function (e) {
            ...
            var filterTags = this.filterTags.val();
            var url = '';

            if (filterTags == '全部标签') {
                filterTags = -1;
            } else {
                filterTags = encodeURIComponent(this.filterTags.val());
            }

            url = '//a.qidian.com/?chanId=' + filterClassify + '&action=' + filterSerial + '&vip=' + filterCharge + '&size=' + filterWords + '&tag=' + filterTags;
